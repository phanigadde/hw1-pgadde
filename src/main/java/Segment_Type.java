...
public class Segment_Type extends Annotation_Type {
  ...
  /** @generated 
     @modifiable */
  @SuppressWarnings ("hiding")
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("Segment");
  ...
  public int getContent(int addr) {
      ...
      jcas.throwFeatMissing("content", "Segment");
  ...
  public Segment_Type(JCas jcas, Type casType) {
    ...
    casFeat_content = jcas.getRequiredFeatureDE(casType, "content", "uima.cas.StringList", featOkTst);
